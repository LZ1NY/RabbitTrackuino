...
mySerial.println("RESET");
  ...
  buzzer_setup();
  mySerial.println("buzzer");
  afsk_setup();
  mySerial.println("afsk");
  gps_setup();
  mySerial.println("gps");
  sensors_setup();
  mySerial.println("sensors");


  mySerial.print("Ti=");
  mySerial.print(sensors_int_lm60());
  mySerial.print(", Te=");
  mySerial.print(sensors_ext_lm60());
  mySerial.print(", Vin=");
  mySerial.println(sensors_vin()/1000.0);
  //char temp[8]; 
  //dtostrf(sensors_vin()/1000.0, 4, 2, temp);
